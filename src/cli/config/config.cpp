...
Config::Config(int argc, char *argv[]) {
    ...
    if (!strcmp(argv[1], "build")) {
        ...
        identity = ADDCOUNT;
    }else if (!strcmp(argv[1], "smoothCounts")) {
        identity = SMOOTHCOUNTS;
    ...
    for (int i = 2; i < argc; ++i) {
        ...
        } else if (!strcmp(argv[i], "--log-counts")) {
            log_counts=true;
...
if (advanced) {
            ...
            fprintf(stderr, "\tsmoothCounts\t\tsmooth counts of unitigs fasta.gz and kmer_counts.gz\n\n");
...
if (advanced) {
            ...
            fprintf(stderr, "\t   --log-counts [INT] \tsave the log of k-mer counts [off]\n");
            fprintf(stderr, "\n");
